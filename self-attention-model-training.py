...
for training the self Attention
...
# Training the model
model = SelfAttention(embedding_dim=128)
epochs = 50
...
train_metrics_df = {'Name':'Self Attention','F1':train_metrics[0],'Precision':train_metrics[1],'Recall':train_metrics[2],'Accuracy':train_metrics[3]}
valid_metrics_df = {'Name':'Self Attention','F1':valid_metrics[0],'Precision':valid_metrics[1],'Recall':valid_metrics[2],'Accuracy':valid_metrics[3]}

training_metrics.append(train_metrics_df)
validation_metrics.append(valid_metrics_df)
print('Finished Self-Attention Model')
print()
...
# Saving the metrics
training_metrics_df.to_csv('model-performances/training-self-attention.csv',index=False)
validation_metrics_df.to_csv('model-performances/validation-self-attention.csv',index=False)
