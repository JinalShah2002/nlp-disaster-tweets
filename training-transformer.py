...
This file is dedicated training the transformer (encoder only)
...
# Saving the metrics
training_metrics_df.to_csv('model-performances/training-transformer.csv',index=False)
validation_metrics_df.to_csv('model-performances/validation-transformer.csv',index=False)
